...
load('Interpolation_ResNet_alternative.mat'); % Residual_NN_Interpolation_Propogation
...
[Multitap_Channel_Signal, Multitap_Channel_Signal_user, Multitap_Channel_Signal_user_for_channel] = Channel.CDL_Channel(Transmitted_signal, Transmitted_signal_for_channel, SNR_OFDM, SampleRate, Carrier_Frequency, Doppler_shift, DelayProfile, DelaySpread, PathDelays, AveragePathGains); 
